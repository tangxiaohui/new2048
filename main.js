(function () {
    ...
    function boot () {
        ...
        var onStart = function () {
			...
			if(window.OPPO && window.OPPO.setLoadingProgress){
				window.OPPO.pvzprogress = 30
				window.OPPO.setLoadingProgress(window.OPPO.pvzprogress)
			}
            // load scene
			/* */
	...
	if(window.OPPO){
		window.OPPO.setWebviewOrientation('landscape')
	}
	if(window.OPPO && window.OPPO.setLoadingProgress){
		window.OPPO.pvzprogress = 0
		window.OPPO.setLoadingProgress(window.OPPO.pvzprogress)
	}
